...
onready var gPage_2 = $Game1/page2
onready var gPage_3 = $Game1/page3
onready var b = $Game1/Bariera
onready var bl = $Game1/Bariera/Label
onready var cs = $Game1/ChangeStage
onready var p = $Pages
